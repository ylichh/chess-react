...
import { obtenDireccionSentidoLineal, esComestible, casillaOcupada } from '../utils/utilidades';
...
describe('getDireccionSentido', () => {
  it('should return the direction and sense of the movement', () => {
    ...
    let direccionSentido = obtenDireccionSentidoLineal(casillaOrigen, casillaDestino);

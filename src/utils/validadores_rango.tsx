...
const _rangoCapturaClasica = (casillaOrigen: CasillaInterface, posicionTablero: TableroInterface) => {
  ...
  let casillasCapturables = [new Casilla({ columna: columnaCapturableIzquierda, fila: filaSiguiente }), new Casilla({ columna: columnaCapturableDerecha, fila: filaSiguiente })];
...
const _rangoCapturaAlPaso = (casillaOrigen: CasillaInterface, casillaAlPasoDisponible: CasillaInterface[]) => {
  ...
  casillaCapazComerAlPaso = casillasCapacesDeCapturarAlPaso.find((casilla) => casilla.getColumna() === casillaOrigen.getColumna() && casilla.getFila() === casillaOrigen.getFila());

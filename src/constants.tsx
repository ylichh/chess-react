...
export const DIRECCIONES_TORRE = [...DIRECCIONES_HORIZONTALES, ...DIRECCIONES_VERTICALES];
export const DIRECCIONES_ALFIL = [...DIRECCIONES_DIAGONALES];
export const DIRECCIONES_REINA = [...DIRECCIONES_TORRE, ...DIRECCIONES_DIAGONALES];

export const PIEZAS_DE_RANGO = [PIEZAS.PEON_BLANCO, PIEZAS.PEON_NEGRO, PIEZAS.CABALLO_BLANCO, PIEZAS.CABALLO_NEGRO, PIEZAS.REY_NEGRO, PIEZAS.REY_BLANCO];
export const PIEZAS_DE_DIRECCION = [PIEZAS.TORRE_BLANCA, PIEZAS.TORRE_NEGRA, PIEZAS.ALFIL_BLANCO, PIEZAS.ALFIL_NEGRO, PIEZAS.REINA_BLANCA, PIEZAS.REINA_NEGRA];
export const PIEZAS_CAMINO_LIBRE = [PIEZAS.TORRE_BLANCA, PIEZAS.TORRE_NEGRA, PIEZAS.ALFIL_BLANCO, PIEZAS.ALFIL_NEGRO, PIEZAS.REINA_BLANCA, PIEZAS.REINA_NEGRA, PIEZAS.REY_NEGRO, PIEZAS.REY_BLANCO];
